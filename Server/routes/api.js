...
router.get('/checkAdmin', userController.checkAdmin);
...
router.get('/tag/:tagName', tagController.findOneTag);
router.post('/tag', tagController.insertTag);
router.put('/tag/:tagName', tagController.updateTag);
router.delete('/tag/:tagName', tagController.deleteTag);
